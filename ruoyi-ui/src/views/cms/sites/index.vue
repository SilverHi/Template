<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="sitesList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="站点目录" prop="sitedir">
          <el-input v-model="form.sitedir" type="text" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="站点名称" prop="sitename">
          <el-input v-model="form.sitename" type="text" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="站点图片" prop="imageurl">
          <el-input v-model="form.imageurl" type="file" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="关键字" prop="keywords">
          <el-input v-model="form.keywords" type="text" placeholder="请输入内容" />
        </el-form-item>
         <el-form-item label="网站类型" prop="sitetype">
           <el-select v-model="form.sitetype" placeholder="请选择">
             <el-option v-for="item in siteType" :key="item.val" :label="item.name" :value="item.val">
             </el-option>
           </el-select>
        </el-form-item>
...
<script>
import { listSites, getSites, delSites, addSites, updateSites } from "@/api/cms/sites";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('cms/sites/export', {
        ...this.queryParams
