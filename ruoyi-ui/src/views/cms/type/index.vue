...
<script>
import { listType, getType, delType, addType, updateType } from "@/api/cms/type";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除vcd类型管理编号为"' + typeIds + '"的数据项？').then(function() {
